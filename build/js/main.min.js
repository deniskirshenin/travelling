...
var _initMenu = require("./modules/menu/init-menu");
...
var _initHero = require("./modules/hero/init-hero");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    (0, _initHero.checkHeaderHeight)();
    (0, _initMenu.openClick)();
...
},{"./modules/form-validate/form":3,"./modules/hero/init-hero":9,"./modules/map/init-map":10,"./modules/menu/init-menu":11,"./modules/swiper/init-swiper":12,"./modules/video/init-video":13,"./utils/ios-vh-fix":15}],2:[function(require,module,exports){
"use strict";
...
exports.checkHeaderHeight = void 0;
var heroSlideWrapper = document.querySelector('.hero__slide-wrapper');
...
var checkHeaderHeight = function checkHeaderHeight() {
  ...
  updateHeroPadding();
  var observer = new ResizeObserver(updateHeroPadding);
  observer.observe(header);
};
exports.checkHeaderHeight = checkHeaderHeight;
...
exports.openClick = void 0;
var menuButton = document.querySelector('.nav__button');
var logo = document.querySelector('.logo__icon');
var navList = document.querySelector('.nav__list');
// const navLink = document.querySelectorAll('.nav__link');
var navTel = document.querySelector('.nav__tel');
var openIcon = document.querySelector('.nav__button-open-icon');
var closeIcon = document.querySelector('.nav__button-close-icon');
var header = document.querySelector('.header');
var nav = document.querySelector('.nav');
var wrapper = document.querySelector('.menu-open-container');
...
var tours = document.querySelector('.tours__wrapper');
var toursButtonPrev = document.querySelector('.tours__button-prev');
var toursButtonNext = document.querySelector('.tours__button-next');
var training = document.querySelector('.training__coaches');
var trainingButtonPrev = document.querySelector('.training__button-prev');
var trainingButtonNext = document.querySelector('.training__button-next');
...
var advantages = document.querySelector('.advantages__wrapper');
var advantagesSwiper;
var advantagesButtonPrev = document.querySelector('.advantages__button-prev');
var advantagesButtonNext = document.querySelector('.advantages__button-next');
var gallery = document.querySelector('.gallery__wrapper');
var galleryButtonPrev = document.querySelector('.gallery__button-prev');
var galleryButtonNext = document.querySelector('.gallery__button-next');
  ...
  return new _swiper.default(hero, {
    ...
    on: {
      slideChange: function slideChange() {
        _initVideo.videoContainer.innerHTML = '';
        _initVideo.image.style.display = 'block';
        _initVideo.button.style.display = 'block';
        if (!audio.innerHTML) {
          audio.innerHTML = '';
        } else {
...
var initToursSwiper = function initToursSwiper() {
  return new _swiper.default(tours, {
...
var initTrainingSwiper = function initTrainingSwiper() {
  return new _swiper.default(training, {
    cssMode: true,
    direction: 'horizontal',
    breakpoints: {
      1200: {
...
var initReviewsSwiper = function initReviewsSwiper() {
  return new _swiper.default(reviews, {
    direction: 'horizontal',
    breakpoints: {
      1200: {
        slidesPerView: 'auto',
...
var initAdvantagesSwiper = function initAdvantagesSwiper() {
  var initSwiper = function initSwiper() {
    advantagesSwiper = new _swiper.default(advantages, {
      direction: 'horizontal',
      loop: true,
      slidesPerView: 'auto',
      autoHeight: true,
...
var initGallerySwiper = function initGallerySwiper() {
  return new _swiper.default(gallery, {
    direction: 'horizontal',
    breakpoints: {
      1200: {
        slidesPerView: 'auto',
...
},{"../../vendor/swiper":16,"../video/init-video":13}],13:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.videoContainer = exports.onPlayClick = exports.image = exports.button = void 0;
...
var image = document.querySelector('#video__poster');
exports.image = image;
var button = document.querySelector('.video__play-button');
